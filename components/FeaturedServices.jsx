    ...
    <div className="flex flex-col xl:flex-row py-2 justify-center bg-white">
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-6 justify-center items-center px-2">
        <Service
          ...
          title={"Essay"}
          desc={
            "Intro, body, and conclusion, with proper formatting and referencing."
          }
        />
        <Service
          ...
          title={"Report"}
          desc={
            "The most professional 9-step structure, from the introduction to the decision."
          }
        />
        <Service
          image={assignmentico}
          alt="essay icon"
          title={"Assignment"}
          desc={"The most reliable standards set by the educational leaders."}
        />
        <Service
          image={casestudyico}
          alt="essay icon"
          title={"Case Study"}
          desc={"The best solutions for any case study of any topic."}
        />
        <Service
          image={reportico}
          alt="essay icon"
          title={"Disseration"}
          desc={
            "5 chapters` breakdown - introduction, literature review, methodology, analysis, and conclusion."
          }
        />
        <Service
          image={essayico}
          ...
          title={"Some title"}
          desc={
            "Some Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda ipsa pariatur"
          }
        />
      </div>
    </div>
